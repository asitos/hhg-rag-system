...
async def benchmark_stt(num_requests: int = 50):
    print(f"Starting FINAL STT benchmark for {num_requests} requests...")
    ...
    with open("bench/stt_results.csv", "w", newline="") as f:
